                ...
                <section className="section-box h-100">
                    ...
                    <div className="key-people  d-flex " style={{
                        ...
                        >
                            ...
                            >
                                <img className="p-20 rounded-circle " style={{marginLeft:'12%',width:'300px',height:'300px',borderRadius:'300px'}}  src="/assets/imgs/page/homepage4/img/research.jpeg" alt="" />
                            ...
                            >
                                <img className="p-20 w-5" style={{marginLeft:'12%',width:'300px',height:'300px',borderRadius:'300px'}} src="/assets/imgs/page/homepage4/img/research.jpeg" alt="" />
